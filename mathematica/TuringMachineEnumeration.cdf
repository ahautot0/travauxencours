...
NotebookDataLength[     85691,       1723]
NotebookOptionsPosition[     58603,       1141]
NotebookOutlinePosition[     84857,       1702]
CellTagsIndexPosition[     84746,       1696]
WindowTitle->Turing Machine Enumeration
WindowFrame->Normal*)
...
Cell["Turing Machine Enumeration", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 3, $CellContext`npct$$ = 
    0.1997467, $CellContext`resize$$ = False, $CellContext`s$$ = 2, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`npct$$], 0.1997467, 
       "fraction of maximum rule number"}, 0, 1}, {{
       Hold[$CellContext`s$$], 2, "possible head states"}, {2, 3, 4}}, {{
       Hold[$CellContext`k$$], 3, "possible tape colors"}, {2, 3, 4}}, {{
       Hold[$CellContext`resize$$], False, "allow resizing"}, {True, False}}},
     Typeset`size$$ = {450., {170., 175.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`npct$153242$$ = 0, $CellContext`s$153243$$ = 
    0, $CellContext`k$153244$$ = 0, $CellContext`resize$153245$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 3, $CellContext`npct$$ = 
        0.1997467, $CellContext`resize$$ = False, $CellContext`s$$ = 2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`npct$$, $CellContext`npct$153242$$, 0], 
        Hold[$CellContext`s$$, $CellContext`s$153243$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$153244$$, 0], 
        Hold[$CellContext`resize$$, $CellContext`resize$153245$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Pane[
        Module[{$CellContext`n$, $CellContext`z$}, $CellContext`z$ = ((
             2 $CellContext`s$$) $CellContext`k$$)^($CellContext`s$$ \
$CellContext`k$$); $CellContext`n$ = Min[-1 + $CellContext`z$, 
            Floor[$CellContext`npct$$ $CellContext`z$]]; Labeled[
           Grid[
            Partition[
             Map[Grid[{{
                 Part[#, 1]}, {
                 Part[#, 2]}}, Dividers -> All, FrameStyle -> 
               Directive[Gray, Dotted]]& , 
              Map[$CellContext`headIndicatorWithTape[
                Part[#, 1], $CellContext`s$$, 
                Part[#, 2], 
                If[Length[#] >= 3, 
                 Part[#, 3], 0], Frame -> False, 
                PlotRange -> {{-1, 2}, {-1, 0}}, ImageSize -> {72, 24}, Axes -> 
                False]& , 
               $CellContext`turingMachineNumberToRules[$CellContext`n$, \
{$CellContext`s$$, $CellContext`k$$, 2}, {
                 Range[$CellContext`s$$], 
                 Range[0, $CellContext`k$$ - 1], {-1, 1}}], {2}]], 4, 4, {1, 
             1}, {}], Dividers -> All, ItemSize -> {8, 8}, 
...
{$CellContext`s$$, $CellContext`k$$, 2}, {
                 Range[$CellContext`s$$], 
                 Range[0, $CellContext`k$$ - 1], {-1, 1}}]]}}]]], {450, 
         If[$CellContext`resize$$, Automatic, 345]}], 
      "Specifications" :> {{{$CellContext`npct$$, 0.1997467, 
          "fraction of maximum rule number"}, 0, 
         1}, {{$CellContext`s$$, 2, "possible head states"}, {2, 3, 
         4}}, {{$CellContext`k$$, 3, "possible tape colors"}, {2, 3, 
         4}}, {{$CellContext`resize$$, False, "allow resizing"}, {
         True, False}}}, 
      "Options" :> {
       TrackedSymbols -> {$CellContext`npct$$, $CellContext`k$$, \
$CellContext`s$$, $CellContext`resize$$}, AutorunSequencing -> {1, 2, 3}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{495., {247., 252.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`headIndicatorWithTape[
          Pattern[$CellContext`state, 
           Blank[]], 
          Pattern[$CellContext`states, 
           Blank[]], 
          Pattern[$CellContext`tapecolor, 
           Blank[]], 
          Pattern[$CellContext`headposition, 
           Blank[]], 
          Pattern[$CellContext`opts, 
           OptionsPattern[]]] := Graphics[{
           OptionValue[ColorFunction][$CellContext`tapecolor], 
           Rectangle[{0, -1}, {1, 0}], 
           OptionValue[ColorFunction][-1], 
           Translate[
            $CellContext`headIndicator[$CellContext`state, \
$CellContext`states], 
            ({
            Part[#, 1, 2] + 1/2, Length[$CellContext`data] - First[#2] + 
             1/2}& )[{{$CellContext`state, $CellContext`headposition, -1}, \
{$CellContext`x, $CellContext`x, $CellContext`x, $CellContext`x}}, {1, 1}]]}, 
          Apply[Sequence, 
           FilterRules[{$CellContext`opts}, 
            Options[Graphics]]]], 
        Options[$CellContext`headIndicatorWithTape] = {
         ColorFunction -> (ColorData[3][# + 2]& ), AlignmentPoint -> Center, 
          ...
          TicksStyle -> {}}, $CellContext`headIndicator[
          Pattern[$CellContext`state, 
           Blank[]], 
          Pattern[$CellContext`states, 
           Blank[]]] := Rotate[
          With[{$CellContext`r = 0.18}, {
            ...
            Polygon[{{$CellContext`r, 0}, {-$CellContext`r, 0}, {
              0, 0.6}, {$CellContext`r, 0}}]}], (2 ($CellContext`state - 1)) (
           Pi/$CellContext`states), {0, 0}], $DisplayFunction = Identity, 
        Attributes[PlotRange] = {
         ReadProtected}, $CellContext`turingMachineNumberToRules[
          Pattern[$CellContext`digits, 
           Blank[Integer]], 
          Pattern[$CellContext`radix, 
           Blank[List]], 
          Pattern[$CellContext`digitLists, {
            Pattern[$CellContext`h, 
             Blank[List]], 
            Pattern[$CellContext`k, 
             Blank[List]], 
            Pattern[$CellContext`r, 
             Blank[List]]}]] := Thread[Tuples[{$CellContext`h, 
             Reverse[$CellContext`k]}] -> 
          Map[$CellContext`MixedBaseDigits[#, $CellContext`radix, \
$CellContext`digitLists]& , 
            IntegerDigits[$CellContext`digits, 
             Apply[Times, $CellContext`radix], 
             Apply[Times, 
              
              Most[$CellContext`radix]]]]], \
$CellContext`turingMachineNumberToRules[
          Pattern[$CellContext`digits, 
           Blank[Integer]], 
          Pattern[$CellContext`radix, 
           Blank[List]], 
          Pattern[$CellContext`digitLists, {
            BlankSequence[List]}]] := IntegerDigits[$CellContext`digits, 
          Apply[Times, $CellContext`radix], 
          Apply[Times, 
           Most[$CellContext`radix]]], $CellContext`MixedBaseDigits[
          Pattern[$CellContext`digits, 
           Blank[List]], 
          Pattern[$CellContext`radix, 
           Blank[List]], 
          Pattern[$CellContext`digitLists, {
            BlankSequence[List]}]] := Mod[
          Quotient[$CellContext`digits, 
           Reverse[
            Most[
             FoldList[Times, 1, 
              
              Reverse[$CellContext`radix]]]]], $CellContext`radix], \
$CellContext`MixedBaseDigits[
          Pattern[$CellContext`digits, 
           Blank[Integer]], 
          Pattern[$CellContext`radix, 
           Blank[List]], 
          Pattern[$CellContext`digitLists, {
            BlankSequence[List]}]] := 
        MapThread[Part, {$CellContext`digitLists, 1 + Mod[
             Quotient[$CellContext`digits, 
              Reverse[
               Most[
                FoldList[Times, 1, 
      ...
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`FromMixedBaseDigits[
            Pattern[$CellContext`n, 
             Blank[List]], 
            Pattern[$CellContext`radix, 
             Blank[List]], 
            Pattern[$CellContext`digitLists, {
              BlankSequence[List]}]] := Dot[
            Reverse[
             Most[
              FoldList[Times, 1, 
               Reverse[$CellContext`radix]]]], 
            MapThread[-1 + Part[
               Position[
                SlotSequence[1]], 1, 
               1]& , {$CellContext`digitLists, $CellContext`n}]]; 
         Null, $CellContext`MixedBaseDigits[
            Pattern[$CellContext`digits, 
             Blank[Integer]], 
            Pattern[$CellContext`radix, 
             Blank[List]], 
               ...
               Quotient[$CellContext`digits, 
                Reverse[
                 Most[
                  FoldList[Times, 1, 
                   Reverse[$CellContext`radix]]]]], $CellContext`radix]}]; 
         Null, $CellContext`turingMachineNumberToRules[
            Pattern[$CellContext`digits, 
             Blank[Integer]], 
            Pattern[$CellContext`radix, 
             Blank[List]], 
...
$CellContext`digitLists]& , 
              IntegerDigits[$CellContext`digits, 
               Apply[Times, $CellContext`radix], 
               Apply[Times, 
                Most[$CellContext`radix]]]]]; Null, $CellContext`headIndicator[
            Pattern[$CellContext`state, 
             Blank[]], 
            Pattern[$CellContext`states, 
             Blank[]]] := Rotate[
            With[{$CellContext`r = 0.18}, {
              ...
              Polygon[{{$CellContext`r, 0}, {-$CellContext`r, 0}, {
                0, 0.6}, {$CellContext`r, 0}}]}], 
            2 ($CellContext`state - 1) (Pi/$CellContext`states), {0, 0}]; 
         Null, $CellContext`headIndicatorWithTape[
            Pattern[$CellContext`state, 
             Blank[]], 
            Pattern[$CellContext`states, 
             Blank[]], 
...
{$CellContext`x, $CellContext`x, $CellContext`x, $CellContext`x}}, {1, 1}]]}, 
            Apply[Sequence, 
             FilterRules[{$CellContext`opts}, 
              Options[Graphics]]]]; Null}]]; Typeset`initDone$$ = True),
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"s", " ", "k"}], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"s", " ", "k", " ", "r"}], TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 ...
 StyleBox["Mathematica",
  FontSlant->"Italic"],
 " for describing one-dimensional Turing machines. The top portion of each of \
the ",
 Cell[BoxData[
  FormBox[
   RowBox[{"s", " ", "k"}], TraditionalForm]], "InlineMath"],
 " cells in the grid shows the input state of the Turing machine while the \
bottom portion shows its output. The integer code of the Turing machine being \
displayed and its associated transition rules are also shown."
}], "ManipulateCaption",
 CellID->365810911],
...
TuringMachineEnumeration&version=0013"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TuringMachineEnumeration/\
TuringMachineEnumeration-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Turing Machine Enumeration",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TuringMachineEnumeration/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TuringMachineEnumeration/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/TuringMachineEnumeration/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TuringMachineEnumeration/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TuringMachineEnumeration/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[49106, 916, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[49367, 925, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[57781, 1116, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 84459, 1685},
 {"Copyright", 84654, 1690}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[590, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34921, 590, 47, 0, 70, "DemoTitle"],
Cell[34971, 592, 12526, 272, 70, "Output",
 CellID->26028847],
Cell[47500, 866, 49, 1, 70, "ManipulateCaption",
 CellID->467634735],
Cell[47552, 869, 983, 30, 70, "ManipulateCaption",
 CellID->18060471],
Cell[48538, 901, 565, 13, 70, "ManipulateCaption",
 CellID->365810911],
Cell[49106, 916, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49367, 925, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[51295, 971, 44, 0, 70, "RelatedLinksSection"],
Cell[51342, 973, 426, 14, 70, "RelatedLinks",
 CellID->346924442],
Cell[51771, 989, 4811, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[56585, 1080, 45, 0, 70, "CitationSection"],
Cell[56633, 1082, 809, 20, 70, "Citations"],
Cell[57445, 1104, 333, 10, 70, "Author"],
Cell[57781, 1116, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature tTqtudffNbdr4v7rdMdVLM1h *)
