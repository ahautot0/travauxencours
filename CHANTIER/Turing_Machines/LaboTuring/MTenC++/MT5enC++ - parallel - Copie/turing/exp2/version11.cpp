...
for (k2 = 0; k2<322;k2++) res[dejavus[k2]]='1';     //Chargement dans res des (entiers correspondants aux) suites déjà imprimées jusqu'à l'ordre 4 inclus
 ...
 ofstream fichier("halting2.txt", ios::out | ios::trunc);  //ouverture en écriture avec effacement du fichier ouvert
 ofstream remise("nested2.txt", ios::out | ios::trunc);
 ofstream overtape("overtape2.txt", ios::out | ios::trunc);

for (nb = 2; nb <402400000000/*00*/; nb+=16) { 
