// SBTM.cpp : Defines the entry point for the application.
//
...
for (k2 = 0; k2<322;k2++) res[dejavus[k2]]='1';     //Chargement dans res des (entiers correspondants aux) suites déjà imprimées jusqu'à l'ordre 4 inclus
 ...
 ofstream fichier("halting6.txt", ios::out | ios::trunc);  //ouverture en écriture avec effacement du fichier ouvert
 ofstream remise("nested6.txt", ios::out | ios::trunc);
 ofstream overtape("overtape6.txt", ios::out | ios::trunc);

for (nb = 0; nb <102400000000/*00*/; nb+=16) { 
